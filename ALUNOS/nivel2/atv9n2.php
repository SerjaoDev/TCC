...
<head>
    ...
    <title>LUMI - Atividade 9 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-l3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA L --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra L -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-l3"><span>LA</span></div>
                <button class="btn-som-l3" onclick="tocarSom('somLA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-l3"><span>LE</span></div>
                <button class="btn-som-l3" onclick="tocarSom('somLE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-l3"><span>LI</span></div>
                <button class="btn-som-l3" onclick="tocarSom('somLI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-l3"><span>LO</span></div>
                <button class="btn-som-l3" onclick="tocarSom('somLO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-l3"><span>LU</span></div>
                <button class="btn-som-l3" onclick="tocarSom('somLU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-l3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação L -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra L -->
            <div class="circulo-letra-b">L</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-l2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="LA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="LE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="LI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="LO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="LU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra L) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-l2">LÁPIS</span>
                    <img src="../img/lapis.png" class="img-figura-l2" alt="Lápis">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-l2">LEÃO</span>
                    <img src="../img/leao.png" class="img-figura-l2" alt="Leão">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-l2">LIVRO</span>
                    <img src="../img/livro.png" class="img-figura-l2" alt="Livro">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-l2">LOBO</span>
                    <img src="../img/lobo.png" class="img-figura-l2" alt="Lobo">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-l2">LUA</span>
                    <img src="../img/lua.png" class="img-figura-l2" alt="Lua">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra L para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="LO">LO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="LA">LA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="LU">LU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="LE">LE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="LI">LI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somLA" src="../audios/Silaba LA.m4a"></audio>
    <audio id="somLE" src="../audios/Silaba LE.m4a"></audio>
    <audio id="somLI" src="../audios/Silaba LI.m4a"></audio>
    <audio id="somLO" src="../audios/Silaba LO.m4a"></audio>
    <audio id="somLU" src="../audios/Silaba LU.m4a"></audio>
