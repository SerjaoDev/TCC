...
<head>
    ...
    <title>LUMI - Atividade D (Nível 2)</title>
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra D -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>DA</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somDA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>DE</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somDE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>DI</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somDI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>DO</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somDO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>DU</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somDU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>
    ...
    <!-- ETAPA 2: Ligação D -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra D -->
            <div class="circulo-letra-b">D</div>
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="DA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="DE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="DI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="DO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="DU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra D) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">DADO</span>
                    <img src="../img/dado.png" class="img-figura-f2" alt="Dado">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">DEDO</span>
                    <img src="../img/dedo.png" class="img-figura-f2" alt="Dedo">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">DINOSSAURO</span>
                    <img src="../img/dinossauro.png" class="img-figura-f2" alt="Dinossauro">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">DOCE</span>
                    <img src="../img/doce.png" class="img-figura-f2" alt="Doce">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">DUENDE</span>
                    <img src="../img/duende.png" class="img-figura-f2" alt="Duende">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra D para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="DO">DO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="DA">DA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="DU">DU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="DE">DE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="DI">DI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somDA" src="../audios/Silaba DA.m4a"></audio>
    <audio id="somDE" src="../audios/Silaba DE.m4a"></audio>
    <audio id="somDI" src="../audios/Silaba DI.m4a"></audio>
    <audio id="somDO" src="../audios/Silaba DO.m4a"></audio>
    <audio id="somDU" src="../audios/Silaba DU.m4a"></audio>
