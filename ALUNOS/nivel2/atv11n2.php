...
<head>
    ...
    <title>LUMI - Atividade 11 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-n3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA N --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra N -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-n3"><span>NA</span></div>
                <button class="btn-som-n3" onclick="tocarSom('somNA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-n3"><span>NE</span></div>
                <button class="btn-som-n3" onclick="tocarSom('somNE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-n3"><span>NI</span></div>
                <button class="btn-som-n3" onclick="tocarSom('somNI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-n3"><span>NO</span></div>
                <button class="btn-som-n3" onclick="tocarSom('somNO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-n3"><span>NU</span></div>
                <button class="btn-som-n3" onclick="tocarSom('somNU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-n3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação N -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra N -->
            <div class="circulo-letra-b">N</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-n2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="NA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="NE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="NI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="NO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="NU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra N) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-n2">NAVIOS</span>
                    <img src="../img/navio.png" class="img-figura-n2" alt="Navio">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-n2">NEVE</span>
                    <img src="../img/neve.png" class="img-figura-n2" alt="Neve">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-n2">NINHO</span>
                    <img src="../img/ninho.png" class="img-figura-n2" alt="Ninho">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-n2">NOVELO</span>
                    <img src="../img/novelo.png" class="img-figura-n2" alt="Novelo">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-n2">NUVEM</span>
                    <img src="../img/nuvem.png" class="img-figura-n2" alt="Nuvem">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra N para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="NO">NO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="NA">NA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="NU">NU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="NE">NE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="NI">NI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somNA" src="../audios/Silaba NA.m4a"></audio>
    <audio id="somNE" src="../audios/Silaba NE.m4a"></audio>
    <audio id="somNI" src="../audios/Silaba NI.m4a"></audio>
    <audio id="somNO" src="../audios/Silaba NO.m4a"></audio>
    <audio id="somNU" src="../audios/Silaba NU.m4a"></audio>
