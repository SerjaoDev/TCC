...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra S -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-s3"><span>SA</span></div>
                <button class="btn-som-s3" onclick="tocarSom('somSA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-s3"><span>SE</span></div>
                <button class="btn-som-s3" onclick="tocarSom('somSE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-s3"><span>SI</span></div>
                <button class="btn-som-s3" onclick="tocarSom('somSI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-s3"><span>SO</span></div>
                <button class="btn-som-s3" onclick="tocarSom('somSO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-s3"><span>SU</span></div>
                <button class="btn-som-s3" onclick="tocarSom('somSU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-s3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação S -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra S -->
            <div class="circulo-letra-s">S</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-s2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="SA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="SE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="SI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="SO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="SU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra S) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-s2">SAPO</span>
                    <img src="../img/sapo.png" class="img-figura-s2" alt="Sapo">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-s2">SEREIA</span>
                    <img src="../img/sereia.png" class="img-figura-s2" alt="Sereia">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-s2">SINO</span>
                    <img src="../img/sino.png" class="img-figura-s2" alt="Sino">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-s2">SOL</span>
                    <img src="../img/sol.png" class="img-figura-s2" alt="Sol">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-s2">SUCO</span>
                    <img src="../img/suco.png" class="img-figura-s2" alt="Suco">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra S para arrastar -->
