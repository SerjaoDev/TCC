...
<head>
    ...
    <style>
        * {
        ...
        .btn-avancar-j3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA J --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra J -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-j3"><span>JA</span></div>
                <button class="btn-som-j3" onclick="tocarSom('somJA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-j3"><span>JE</span></div>
                <button class="btn-som-j3" onclick="tocarSom('somJE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-j3"><span>JI</span></div>
                <button class="btn-som-j3" onclick="tocarSom('somJI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-j3"><span>JO</span></div>
                <button class="btn-som-j3" onclick="tocarSom('somJO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-j3"><span>JU</span></div>
                <button class="btn-som-j3" onclick="tocarSom('somJU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-j3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação J -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra J -->
            <div class="circulo-letra-b">J</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-j2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="JA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="JE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="JI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="JO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="JU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra J) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-j2">JACARÉ</span>
                    <img src="../img/jacare.png" class="img-figura-j2" alt="Jacaré">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-j2">JEGUE</span>
                    <img src="../img/jegue.png" class="img-figura-j2" alt="Jegue">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-j2">JIBÓIA</span>
                    <img src="../img/jiboia.png" class="img-figura-j2" alt="Jibóia">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-j2">JOANINHA</span>
                    <img src="../img/joaninha.png" class="img-figura-j2" alt="Joaninha">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-j2">JUJUBA</span>
                    <img src="../img/jujuba.png" class="img-figura-j2" alt="Jujuba">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra J para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="JO">JO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="JA">JA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="JU">JU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="JE">JE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="JI">JI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somJA" src="../audios/Silaba JA.m4a"></audio>
    <audio id="somJE" src="../audios/Silaba JE.m4a"></audio>
    <audio id="somJI" src="../audios/Silaba JI.m4a"></audio>
    <audio id="somJO" src="../audios/Silaba JO.m4a"></audio>
    <audio id="somJU" src="../audios/Silaba JU.m4a"></audio>
