...
<head>
    ...
    <title>LUMI - Atividade F (Nível 2)</title>
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra F -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>FA</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somFA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>FE</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somFE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>FI</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somFI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>FO</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somFO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-f3"><span>FU</span></div>
                <button class="btn-som-f3" onclick="tocarSom('somFU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>
    ...
    <!-- ETAPA 2: Ligação F -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra F -->
            <div class="circulo-letra-b">F</div>
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="FA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="FE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="FI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="FO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="FU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra F) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">FADA</span>
                    <img src="../img/fada.png" class="img-figura-f2" alt="Fada">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">FEIJÃO</span>
                    <img src="../img/feijao.png" class="img-figura-f2" alt="Feijão">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">FITA</span>
                    <img src="../img/fita.png" class="img-figura-f2" alt="Fita">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">FOGO</span>
                    <img src="../img/fogo.png" class="img-figura-f2" alt="Fogo">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-f2">FUMAÇA</span>
                    <img src="../img/fumaca.png" class="img-figura-f2" alt="Fumaça">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra F para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="FO">FO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="FA">FA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="FU">FU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="FE">FE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="FI">FI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somFA" src="../audios/Silaba FA.m4a"></audio>
    <audio id="somFE" src="../audios/Silaba FE.m4a"></audio>
    <audio id="somFI" src="../audios/Silaba FI.m4a"></audio>
    <audio id="somFO" src="../audios/Silaba FO.m4a"></audio>
    <audio id="somFU" src="../audios/Silaba FU.m4a"></audio>
