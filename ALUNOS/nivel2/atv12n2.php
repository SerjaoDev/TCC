...
<head>
    ...
    <title>LUMI - Atividade 12 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-p3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA P --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra P -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-p3"><span>PA</span></div>
                <button class="btn-som-p3" onclick="tocarSom('somPA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-p3"><span>PE</span></div>
                <button class="btn-som-p3" onclick="tocarSom('somPE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-p3"><span>PI</span></div>
                <button class="btn-som-p3" onclick="tocarSom('somPI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-p3"><span>PO</span></div>
                <button class="btn-som-p3" onclick="tocarSom('somPO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-p3"><span>PU</span></div>
                <button class="btn-som-p3" onclick="tocarSom('somPU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-p3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação P -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra P -->
            <div class="circulo-letra-b">P</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-p2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="PA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="PE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="PI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="PO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="PU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra P) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-p2">PATO</span>
                    <img src="../img/pato.png" class="img-figura-p2" alt="Pato">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-p2">PEIXE</span>
                    <img src="../img/peixe.png" class="img-figura-p2" alt="Peixe">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-p2">PIPOCA</span>
                    <img src="../img/pipoca.png" class="img-figura-p2" alt="Pipoca">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-p2">PORCO</span>
                    <img src="../img/porco.png" class="img-figura-p2" alt="Porco">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-p2">PUDIM</span>
                    <img src="../img/pudim.png" class="img-figura-p2" alt="Pudim">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra P para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="PO">PO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="PA">PA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="PU">PU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="PE">PE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="PI">PI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somPA" src="../audios/Silaba PA.m4a"></audio>
    <audio id="somPE" src="../audios/Silaba PE.m4a"></audio>
    <audio id="somPI" src="../audios/Silaba PI.m4a"></audio>
    <audio id="somPO" src="../audios/Silaba PO.m4a"></audio>
    <audio id="somPU" src="../audios/Silaba PU.m4a"></audio>
