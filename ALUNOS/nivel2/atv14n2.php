...
<head>
    ...
    <title>LUMI - Atividade 14 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-r3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA R --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra R -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-r3"><span>RA</span></div>
                <button class="btn-som-r3" onclick="tocarSom('somRA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-r3"><span>RE</span></div>
                <button class="btn-som-r3" onclick="tocarSom('somRE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-r3"><span>RI</span></div>
                <button class="btn-som-r3" onclick="tocarSom('somRI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-r3"><span>RO</span></div>
                <button class="btn-som-r3" onclick="tocarSom('somRO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-r3"><span>RU</span></div>
                <button class="btn-som-r3" onclick="tocarSom('somRU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-r3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação R -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra R -->
            <div class="circulo-letra-b">R</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-r2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="RA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="RE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="RI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="RO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="RU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra R) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-r2">RATO</span>
                    <img src="../img/rato.png" class="img-figura-r2" alt="Rato">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-r2">RELÓGIO</span>
                    <img src="../img/relogio.png" class="img-figura-r2" alt="Relógio">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-r2">RIO</span>
                    <img src="../img/rio.png" class="img-figura-r2" alt="Rio">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-r2">ROBÔ</span>
                    <img src="../img/robo.png" class="img-figura-r2" alt="Robô">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-r2">RUA</span>
                    <img src="../img/rua.png" class="img-figura-r2" alt="Rua">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra R para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="RO">RO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="RA">RA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="RU">RU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="RE">RE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="RI">RI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somRA" src="../audios/Silaba RA.m4a"></audio>
    <audio id="somRE" src="../audios/Silaba RE.m4a"></audio>
    <audio id="somRI" src="../audios/Silaba RI.m4a"></audio>
    <audio id="somRO" src="../audios/Silaba RO.m4a"></audio>
    <audio id="somRU" src="../audios/Silaba RU.m4a"></audio>
