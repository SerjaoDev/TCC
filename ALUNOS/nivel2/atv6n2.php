...
<head>
    ...
    <title>LUMI - Atividade 6 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-h3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA H --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra H -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-h3"><span>HA</span></div>
                <button class="btn-som-h3" onclick="tocarSom('somHA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-h3"><span>HE</span></div>
                <button class="btn-som-h3" onclick="tocarSom('somHE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-h3"><span>HI</span></div>
                <button class="btn-som-h3" onclick="tocarSom('somHI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-h3"><span>HO</span></div>
                <button class="btn-som-h3" onclick="tocarSom('somHO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-h3"><span>HU</span></div>
                <button class="btn-som-h3" onclick="tocarSom('somHU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-h3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação H -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra H -->
            <div class="circulo-letra-b">H</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-h2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="HA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="HE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="HI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="HO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="HU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra H) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-h2">HARPA</span>
                    <img src="../img/harpa.png" class="img-figura-h2" alt="Harpa">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-h2">HELICÓPTERO</span>
                    <img src="../img/helicoptero.png" class="img-figura-h2" alt="Helicóptero">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-h2">HIPOPÓTAMO</span>
                    <img src="../img/hipopotamo.png" class="img-figura-h2" alt="Hipopótamo">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-h2">HORTA</span>
                    <img src="../img/horta.png" class="img-figura-h2" alt="Horta">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-h2">HULK</span>
                    <img src="../img/hulk.png" class="img-figura-h2" alt="Hulk">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra H para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="HO">HO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="HA">HA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="HU">HU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="HE">HE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="HI">HI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somHA" src="../audios/Silaba HA.m4a"></audio>
    <audio id="somHE" src="../audios/Silaba HE.m4a"></audio>
    <audio id="somHI" src="../audios/Silaba HI.m4a"></audio>
    <audio id="somHO" src="../audios/Silaba HO.m4a"></audio>
    <audio id="somHU" src="../audios/Silaba HU.m4a"></audio>
