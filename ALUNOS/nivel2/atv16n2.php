...
<head>
    ...
    <title>LUMI - Atividade 16 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-t3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA T --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra T -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-t3"><span>TA</span></div>
                <button class="btn-som-t3" onclick="tocarSom('somTA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-t3"><span>TE</span></div>
                <button class="btn-som-t3" onclick="tocarSom('somTE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-t3"><span>TI</span></div>
                <button class="btn-som-t3" onclick="tocarSom('somTI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-t3"><span>TO</span></div>
                <button class="btn-som-t3" onclick="tocarSom('somTO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-t3"><span>TU</span></div>
                <button class="btn-som-t3" onclick="tocarSom('somTU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-t3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação T -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra T -->
            <div class="circulo-letra-t">T</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-t2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="TA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="TE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="TI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="TO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="TU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra T) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-t2">TATU</span>
                    <img src="../img/tatu.png" class="img-figura-t2" alt="Tatu">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-t2">TELEFONE</span>
                    <img src="../img/telefone.png" class="img-figura-t2" alt="Telefone">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-t2">TIGRE</span>
                    <img src="../img/tigre.png" class="img-figura-t2" alt="Tigre">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-t2">TOMATE</span>
                    <img src="../img/tomate.png" class="img-figura-t2" alt="Tomate">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-t2">TUBARÃO</span>
                    <img src="../img/tubarao.png" class="img-figura-t2" alt="Tubarão">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra T para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="TO">TO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="TA">TA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="TU">TU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="TE">TE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="TI">TI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somTA" src="../audios/Silaba TA.m4a"></audio>
    <audio id="somTE" src="../audios/Silaba TE.m4a"></audio>
    <audio id="somTI" src="../audios/Silaba TI.m4a"></audio>
    <audio id="somTO" src="../audios/Silaba TO.m4a"></audio>
    <audio id="somTU" src="../audios/Silaba TU.m4a"></audio>
