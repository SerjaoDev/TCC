...
<head>
    ...
    <title>LUMI - Atividade 10 (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-m3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA M --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra M -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-m3"><span>MA</span></div>
                <button class="btn-som-m3" onclick="tocarSom('somMA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-m3"><span>ME</span></div>
                <button class="btn-som-m3" onclick="tocarSom('somME')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-m3"><span>MI</span></div>
                <button class="btn-som-m3" onclick="tocarSom('somMI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-m3"><span>MO</span></div>
                <button class="btn-som-m3" onclick="tocarSom('somMO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-m3"><span>MU</span></div>
                <button class="btn-som-m3" onclick="tocarSom('somMU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-m3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação M -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <div class="circulo-letra-b">M</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-m2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="MA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="ME" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="MI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="MO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="MU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra M) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-m2">MALA</span>
                    <img src="../img/mala.png" class="img-figura-m2" alt="Mala">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-m2">MEIA</span>
                    <img src="../img/meia.png" class="img-figura-m2" alt="Meia">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-m2">MILHO</span>
                    <img src="../img/milho.png" class="img-figura-m2" alt="Milho">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-m2">MOTO</span>
                    <img src="../img/moto.png" class="img-figura-m2" alt="Moto">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-m2">MULA</span>
                    <img src="../img/mula.png" class="img-figura-m2" alt="Mula">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra M para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="MO">MO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="MA">MA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="MU">MU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="ME">ME</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="MI">MI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somMA" src="../audios/Silaba MA.m4a"></audio>
    <audio id="somME" src="../audios/Silaba ME.m4a"></audio>
    <audio id="somMI" src="../audios/Silaba MI.m4a"></audio>
    <audio id="somMO" src="../audios/Silaba MO.m4a"></audio>
    <audio id="somMU" src="../audios/Silaba MU.m4a"></audio>
