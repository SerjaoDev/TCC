...
<head>
    ...
    <title>LUMI - Atividade K (Nível 2)</title>
    ...
    <style>
        * {
        ...
        .btn-avancar-k3:hover {
            background-color: #1a1a1a;
            color: #ffffff;
        }

        /* --- ETAPA 2: LIGAÇÃO DA LETRA K --- */
...
<body>
    ...
    <!-- ETAPA 1: Apresentação das Sílabas da letra K -->
    <div id="etapa1" class="etapa-container">
        <div class="grid-cards-etapa1">
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-k3"><span>KA</span></div>
                <button class="btn-som-k3" onclick="tocarSom('somKA')">
            ...
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-k3"><span>KE</span></div>
                <button class="btn-som-k3" onclick="tocarSom('somKE')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-k3"><span>KI</span></div>
                <button class="btn-som-k3" onclick="tocarSom('somKI')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-k3"><span>KO</span></div>
                <button class="btn-som-k3" onclick="tocarSom('somKO')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
            <div class="card-bloco-etapa1">
                <div class="card-amarelo-k3"><span>KU</span></div>
                <button class="btn-som-k3" onclick="tocarSom('somKU')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2.5"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
                </button>
            </div>
        </div>

        <button class="btn-avancar-k3" onclick="mudarEtapa('etapa1', 'etapa2')">➔</button>
    </div>

    <!-- ETAPA 2: Ligação K -> Vogais + Imagens Alinhadas -->
    <div id="etapa2" class="etapa-container esconder">
        <div class="painel-ligacao-container">
            ...
            <!-- Círculo com a letra K -->
            <div class="circulo-letra-b">K</div>

            <!-- Coluna de Círculos com Vogais -->
            <div class="coluna-vogais-k2">
            ...
            <div class="coluna-drops">
                <div class="quadrado-drop" data-esperado="KA" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="KE" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="KI" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="KO" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
                <div class="quadrado-drop" data-esperado="KU" ondragover="permitirDrop(event)" ondragleave="sairDrop(event)" ondrop="soltarSilaba(event)"></div>
            </div>

            <!-- Coluna de Figuras Correspondentes Alinhadas (Letra K) -->
            <div class="coluna-figuras-alinhadas">
                <div class="card-figura-alinhada">
                    <span class="texto-figura-k2">KARATÊ</span>
                    <img src="../img/karate.png" class="img-figura-k2" alt="Karatê">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-k2">KETCHUP</span>
                    <img src="../img/ketchup.png" class="img-figura-k2" alt="Ketchup">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-k2">KIWI</span>
                    <img src="../img/kiwi.png" class="img-figura-k2" alt="Kiwi">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-k2">KOMBI</span>
                    <img src="../img/kombi.png" class="img-figura-k2" alt="Kombi">
                </div>
                <div class="card-figura-alinhada">
                    <span class="texto-figura-k2">KUNG FU</span>
                    <img src="../img/kungfu.png" class="img-figura-k2" alt="Kung Fu">
                </div>
            </div>
        </div>

        <!-- Sílabas da letra K para arrastar -->
        <div class="container-opcoes-arrastaveis">
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="KO">KO</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="KA">KA</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="KU">KU</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="KE">KE</div>
            <div class="silaba-opcao" draggable="true" ondragstart="arrastarSilaba(event)" data-silaba="KI">KI</div>
        </div>
    </div>

    <!-- ÁUDIOS DAS SÍLABAS E PALAVRAS -->
    <audio id="somKA" src="../audios/Silaba KA.m4a"></audio>
    <audio id="somKE" src="../audios/Silaba KE.m4a"></audio>
    <audio id="somKI" src="../audios/Silaba KI.m4a"></audio>
    <audio id="somKO" src="../audios/Silaba KO.m4a"></audio>
    <audio id="somKU" src="../audios/Silaba KU.m4a"></audio>
