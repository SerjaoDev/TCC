...
<body>
    ...
    <div id="etapa1" class="etapa-container etapa-simples">
        <div class="card-letra-wrapper">
            ...
            <button class="btn-som" onclick="tocarSom('somLetraM')" title="Ouvir som da letra M">
    ...
    <div id="etapa3" class="etapa-container etapa-simples esconder">
        <div class="card-letra-wrapper">
            ...
            <button class="btn-som" onclick="tocarSom('somLetraN')" title="Ouvir som da letra N">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
            </button>
        </div>
    ...
    <div id="etapa6" class="esconder">
        <div class="jogo-wrapper-etapa6">
            <div class="painel-dropzones">
                ...
                <div class="card-drop" data-letra="o" ondragover="permitirSoltar(event)" ondragleave="sairDrop(event)" ondrop="soltar(event)">
                    <span>Oo</span>
                </div>
            </div>

            <div class="grid-figuras">
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-maca" data-letra="m">
                    <img src="../img/maca.png" alt="Maçã">
                </div>
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-melancia" data-letra="m">
                    <img src="../img/melancia.png" alt="Melancia">
                </div>

                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-foca" data-letra="nenhuma">
                    <img src="../img/Foca.png" alt="Foca">
                </div>
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-bola" data-letra="nenhuma">
                    <img src="../img/bola.png" alt="Bola">
                </div>

                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-nuvens" data-letra="n">
                    <img src="../img/Nuvens.png" alt="Nuvens">
                </div>
            </div>
        </div>
        <button id="btn-avancar-etapa6" class="btn-avancar" onclick="mudarEtapa('etapa6', 'etapa7')" disabled>➔</button>
    </div>
    ...
    <div id="etapa7" class="esconder">
        <div class="painel-letras">
            ...
            <div class="card-letra-arrastavel" draggable="true" ondragstart="arrastarLetra(event)" id="letra-O" data-letra="o">
                <span>Oo</span>
            </div>
        </div>
    ...
    <audio id="somLetraM" src="../audios/Letra M.m4a"></audio>
    <audio id="somLetraN" src="../audios/Letra N.m4a"></audio>
        ...
        function soltar(event) {
            ...
            if (letraFigura === letraZona) {
                ...
                if (acertos === TOTAL_ACERTOS) {
                    const btnAvancar6 = document.getElementById('btn-avancar-etapa6');
                    if (btnAvancar6) {
                        btnAvancar6.removeAttribute('disabled');
                    }
                }
            } else {
                tocarSom('somErro');
