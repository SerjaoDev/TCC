    ...
    try {
        $stmt = $pdo->prepare("
            ...
            ON DUPLICATE KEY UPDATE
                nivel_atual = GREATEST(nivel_atual, 5),
...
<head>
    ...
    <title>LUMI - Atividade 5 (Nível 1)</title>
...
<body>
    ...
    <div id="etapa1" class="etapa-container etapa-simples">
        <div class="card-letra-wrapper">
            ...
            <button class="btn-som" onclick="tocarSom('somLetraK')" title="Ouvir som da letra K">
    ...
    <div id="etapa2" class="etapa-container esconder">
        <div class="conteudo-etapa">
            ...
            <div class="lista-palavras">
                <button class="btn-palavra" onclick="tocarSom('somKiwi')">
                    <span>KIWI</span>
                    <img src="../img/kiwi.png" alt="Kiwi">
                </button>
                <button class="btn-palavra" onclick="tocarSom('somKetchup')">
                    <span>KETCHUP</span>
                    <img src="../img/ketchup.png" alt="Ketchup">
                </button>
                <button class="btn-palavra" onclick="tocarSom('somKarate')">
                    <span>KARATÊ</span>
                    <img src="../img/karate.png" alt="Karate">
                </button>
            </div>
        </div>
    ...
    <div id="etapa3" class="etapa-container etapa-simples esconder">
        <div class="card-letra-wrapper">
            ...
            <button class="btn-som" onclick="tocarSom('somLetraL')" title="Ouvir som da letra L">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1a1a1a" stroke-width="2"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>
            </button>
        </div>
    ...
    <div id="etapa4" class="etapa-container esconder">
        <div class="conteudo-etapa">
            ...
            <div class="lista-palavras">
                <button class="btn-palavra" onclick="tocarSom('somLapis')">
                    <span>LÁPIS</span>
                    <img src="../img/lapis.png" alt="Lapis">
                </button>
                <button class="btn-palavra" onclick="tocarSom('somLivro')">
                    <span>LIVRO</span>
                    <img src="../img/livro.png" alt="Livro">
                </button>
                <button class="btn-palavra" onclick="tocarSom('somLeao')">
                    <span>LEÃO</span>
                    <img src="../img/leao.png" alt="Leão">
                </button>
            </div>
        </div>
    ...
    <div id="etapa5" class="esconder">
        <div class="jogo-wrapper-etapa5">
            <div class="painel-dropzones">
                <div class="card-drop" data-letra="k" ondragover="permitirSoltar(event)" ondragleave="sairDrop(event)" ondrop="soltar(event)">
                    <span>Kk</span>
                </div>
                ...
                <div class="card-drop" data-letra="l" ondragover="permitirSoltar(event)" ondragleave="sairDrop(event)" ondrop="soltar(event)">
                    <span>Ll</span>
                </div>
            </div>

            <div class="grid-figuras">
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-kiwi" data-letra="k">
                    <img src="../img/kiwi.png" alt="kiwi">
                </div>
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-ketchup" data-letra="k">
                    <img src="../img/ketchup.png" alt="ketchup">
                </div>

                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-karate" data-letra="k">
                    <img src="../img/karate.png" alt="karate">
                </div>

                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-doce" data-letra="nenhuma">
                    <img src="../img/doce.png" alt="Doce">
                </div>
                
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-leao" data-letra="l">
                ...
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-lapis" data-letra="l">
                    <img src="../img/lapis.png" alt="lapis">
                </div>
                
                <div class="item-figura" draggable="true" ondragstart="arrastar(event)" id="fig-livro" data-letra="l">
                    <img src="../img/livro.png" alt="Livro">
                </div>
    ...
    <div id="etapa6" class="esconder">
        <div class="painel-letras">
            <div class="card-letra-arrastavel" draggable="true" ondragstart="arrastarLetra(event)" id="letra-K" data-letra="k">
                <span>Kk</span>
            </div>
            ...
            <div class="card-letra-arrastavel" draggable="true" ondragstart="arrastarLetra(event)" id="letra-L" data-letra="l">
                <span>Ll</span>
            </div>
        </div>

        <div class="grid-palavras-jogo">
            <div class="card-palavra-drop" data-correta="k" data-resto="IWI" data-audio="somKiwi" ondragover="permitirSoltarLetra(event)" ondragleave="sairDropLetra(event)" ondrop="soltarLetra(event)">
                <span class="texto-palavra">_IWI</span>
                <img src="../img/kiwi.png" alt="Kiwi" class="imagem-palavra">
            </div>

            <div class="card-palavra-drop" data-correta="k" data-resto="ETCHUP" data-audio="somKetchup" ondragover="permitirSoltarLetra(event)" ondragleave="sairDropLetra(event)" ondrop="soltarLetra(event)">
                <span class="texto-palavra">_ETCHUP</span>
                <img src="../img/ketchup.png" alt="Ketchup" class="imagem-palavra">
            </div>

            <div class="card-palavra-drop" data-correta="k" data-resto="ARATÊ" data-audio="somKarate" ondragover="permitirSoltarLetra(event)" ondragleave="sairDropLetra(event)" ondrop="soltarLetra(event)">
                <span class="texto-palavra">_ARATÊ</span>
                <img src="../img/karate.png" alt="Karatê" class="imagem-palavra">
            </div>

            <div class="card-palavra-drop" data-correta="l" data-resto="ÁPIS" data-audio="somLapis" ondragover="permitirSoltarLetra(event)" ondragleave="sairDropLetra(event)" ondrop="soltarLetra(event)">
                <span class="texto-palavra">_ÁPIS</span>
                <img src="../img/lapis.png" alt="Lápis" class="imagem-palavra">
            </div>

            <div class="card-palavra-drop" data-correta="l" data-resto="IVRO" data-audio="somLivro" ondragover="permitirSoltarLetra(event)" ondragleave="sairDropLetra(event)" ondrop="soltarLetra(event)">
                <span class="texto-palavra">_IVRO</span>
                <img src="../img/livro.png" alt="Livro" class="imagem-palavra">
            </div>

            <div class="card-palavra-drop" data-correta="l" data-resto="EÃO" data-audio="somLeao" ondragover="permitirSoltarLetra(event)" ondragleave="sairDropLetra(event)" ondrop="soltarLetra(event)">
                <span class="texto-palavra">_EÃO</span>
                <img src="../img/leao.png" alt="Leão" class="imagem-palavra">
            </div>
        </div>
    </div>

    <audio id="audioIniciando" src="../audios/iniciando_fase.mp3" autoplay></audio>
    <audio id="somLetraK" src="../audios/Letra K.m4a"></audio>
    <audio id="somLetraL" src="../audios/Letra L.m4a"></audio>

    <audio id="somKiwi" src="../audios/Kiwi.mp3"></audio>
    <audio id="somKetchup" src="../audios/Ketchup.mp3"></audio>
    <audio id="somKarate" src="../audios/Karatê.mp3"></audio>

    <audio id="somLapis" src="../audios/Lápis.mp3"></audio>
    <audio id="somLivro" src="../audios/Livro.mp3"></audio>
    <audio id="somLeao" src="../audios/Leão.mp3"></audio>
